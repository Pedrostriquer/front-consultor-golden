    ...
    <svg viewBox="0 0 293 368" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <defs>
        <filter id="glow" x="-50%" y="-50%" width="4000%" height="4000%"> {/* Aumenta a área de atuação do filtro */}
          ...
          <feFlood floodColor="#D4AF37" floodOpacity="0.8" result="color1" /> {/* Cor do brilho com opacidade */}
          ...
          <feFlood floodColor="#D4AF37" floodOpacity="1" result="color2" /> {/* Cor do brilho principal, opaco */}
